...
class DeploymentControllerApi(object):
    ...
    def create_using_post4(self, body, **kwargs):  # noqa: E501
        ...
        :param Deployment body: entity (required)
        :return: Deployment
    ...
    def list_using_get4_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PageOfDeployment',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_using_put4(self, body, id, **kwargs):  # noqa: E501
        """Update the given instance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_using_put4(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_using_put4_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_using_put4_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_using_put4_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update the given instance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_using_put4_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_using_put4`")  # noqa: E501
