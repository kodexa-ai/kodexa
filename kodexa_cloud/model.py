...
#   timestamp: 2020-04-21T14:28:17+00:00
...
class PipelineParameterMetadata(BaseModel):
    name: Optional[str] = None
...
class WebHookDeployment(DeploymentMetadata):
    accessToken: Optional[str] = None
    botId: Optional[str] = None
    type: str
    uuid: Optional[str] = None
...
class PipelineMetadata(BaseModel):
    parameters: Optional[List['PipelineParameterMetadata']] = None
