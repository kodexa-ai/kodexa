...
#   timestamp: 2021-10-24T14:06:54+00:00
...
class CustomEventDefinition(KodexaBaseModel):
    name: Optional[str] = None
    icon: Optional[str] = None
...
class AssistantDefinition(SlugBasedMetadata):
    ...
    event_types: Optional[List[CustomEventDefinition]] = Field(
        None,
        alias='eventTypes',
