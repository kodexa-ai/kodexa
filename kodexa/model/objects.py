...
#   timestamp: 2022-07-31T16:18:57+00:00
...
class PipelineStepMetadata(KodexaBaseModel):
    ...
    step_type: Optional[StepType1] = Field(
...
class ProjectStore(KodexaBaseModel):
    ...
    store_purpose: Optional[StorePurpose1] = Field(None, alias='storePurpose')
...
class DeploymentMetadata(KodexaBaseModel):
    """
    Details of the model deployment (if available)
    """
...
class ExecutionStep(KodexaBaseModel):
    ...
    step_type: Optional[StepType] = Field(None, alias='stepType')
...
class SlugBasedMetadata(KodexaBaseModel):
    ...
    #     Credential,
    #     DataForm,
    # ] = Field(..., description='Services used by the assistant')
...
class DataObject(KodexaBaseModel):
    ...
    tag_metadata: Optional[List[TagMetadata]] = Field(
        None,
        alias='tagMetadata',
        description='A list tag metadata for the data object',
        unique_items=True,
    )
...
class Taxonomy(KodexaBaseModel):
    """
...
class AssistantDefinition(KodexaBaseModel):
...
class Credential(KodexaBaseModel):
    extension_pack_ref: Optional[str] = Field(
        None,
        alias='extensionPackRef',
        description='The reference to the extension pack (if the metadata object was created by an extension pack)',
...
class Dashboard(KodexaBaseModel):
    extension_pack_ref: Optional[str] = Field(
        None,
        alias='extensionPackRef',
        description='The reference to the extension pack (if the metadata object was created by an extension pack)',
...
class DataForm(KodexaBaseModel):
    extension_pack_ref: Optional[str] = Field(
        None,
        alias='extensionPackRef',
        description='The reference to the extension pack (if the metadata object was created by an extension pack)',
...
class ExtensionPack(KodexaBaseModel):
...
class ModelRuntime(KodexaBaseModel):
    extension_pack_ref: Optional[str] = Field(
        None,
        alias='extensionPackRef',
        description='The reference to the extension pack (if the metadata object was created by an extension pack)',
...
class ProjectTemplate(KodexaBaseModel):
    extension_pack_ref: Optional[str] = Field(
        None,
        alias='extensionPackRef',
        description='The reference to the extension pack (if the metadata object was created by an extension pack)',
...
PageCredential.update_forward_refs()
