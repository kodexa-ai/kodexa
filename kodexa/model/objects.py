...
#   timestamp: 2022-07-01T17:09:09+00:00
...
class DataFormCard(KodexaBaseModel):
    taxon_path: Optional[str] = Field(None, alias='taxonPath')
    html_content: Optional[str] = Field(None, alias='htmlContent')
    classes: Optional[List[str]] = None


class DataObjectFormLayout(KodexaBaseModel):
    cards: Optional[List[DataFormCard]] = None
...
class Taxon(KodexaBaseModel):
    ...
    form_layout: Optional[DataObjectFormLayout] = Field(None, alias='formLayout')
...
class ModelContentMetadata(ContentMetadata):
    ...
    model_runtime_parameters: Optional[Dict[str, Dict[str, Any]]] = Field(
        None,
    ...
    training_parameters: Optional[Dict[str, Dict[str, Any]]] = Field(
        None,
    ...
    inference_parameters: Optional[Dict[str, Dict[str, Any]]] = Field(
        None,
