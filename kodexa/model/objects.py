...
#   timestamp: 2022-03-03T15:23:06+00:00
...
class ModelContentMetadata(ContentMetadata):
    ...
    model_runtime_parameters: Optional[Dict[str, Any]] = Field(
        ...
        description='The parameters passed to the model runtime for base configuration',
    )
...
class ModelTrainEvent(KodexaBaseModel):
    ...
    subscriptions: Optional[
        List[Union[LabelSubscription, MixinSubscription, PathSubscription]]
    ] = None
