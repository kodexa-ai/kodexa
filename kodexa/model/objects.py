...
#   timestamp: 2022-07-05T07:28:33+00:00
...
class BaseCard(KodexaBaseModel):
...
class DataForm(SlugBasedMetadata):
    ...
    path: Optional[str] = None
    cards: Optional[List[BaseCard]] = None
