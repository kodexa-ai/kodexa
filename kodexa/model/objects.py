...
#   timestamp: 2021-11-01T09:26:11+00:00
...
class ExecutionStatusUpdate(KodexaBaseModel):
    status: Optional[str] = None
...
class ModelTrainRequest(KodexaBaseModel):
    options: Dict[str, Dict[str, Any]]
    training_store: Store = Field(..., alias='trainingStore')
    subscriptions: Optional[List[EventSubscription]] = None
...
class ModelContentMetadata(ContentMetadata):
    ...
    last_train_event: Optional[ModelTrainEvent] = Field(None, alias='lastTrainEvent')
