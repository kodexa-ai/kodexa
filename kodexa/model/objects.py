...
#   timestamp: 2021-10-21T21:07:45+00:00
...
class AssistantSubscription(KodexaBaseModel):
...
class AccessTokenDetails(KodexaBaseModel):
    type: Optional[str] = None
    token: Optional[str] = None
    organization_slugs: Optional[List[str]] = Field(None, alias='organizationSlugs')
...
class ModelContentMetadata(ContentMetadata):
    ...
    deployment: Optional[DeploymentMetadata] = None
    an_optional_taxonomy_that_can_be_provided_to_support_labeling: Optional[
        Taxonomy
    ] = Field(
        None, alias='An optional taxonomy that can be provided to support labeling'
    )
...
class ContentObject(KodexaBaseModel):
    ...
    mixins: Optional[List[str]] = None
    content_metadata: Optional[Dict[str, Dict[str, Any]]] = Field(
        None, alias='contentMetadata'
    )
...
class AssistantPipeline(KodexaBaseModel):
    description: Optional[str] = None
...
class AssistantResponse(KodexaBaseModel):
    text: Optional[str] = None
    pipelines: Optional[List[AssistantPipeline]] = None


class CloudAssistant(KodexaBaseModel):
...
class SessionEvent(KodexaBaseModel):
    id: str
    type: Type
    execution_id: Optional[str] = Field(None, alias='executionId')
    store_ref: Optional[str] = Field(None, alias='storeRef')
...
class AssistantDefinition(SlugBasedMetadata):
    ...
    event_filters: Optional[List[EventFilter]] = Field(None, alias='eventFilters')
...
class PlatformEvent(KodexaBaseModel):
    ...
    event_detail: Optional[
        Union[BaseEvent, AssistantEvent, ContentEvent, ScheduledEvent]
