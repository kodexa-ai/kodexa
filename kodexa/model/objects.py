...
#   timestamp: 2022-08-10T09:45:53+00:00
...
class DataAttribute(KodexaBaseModel):
    ...
    created_on: Optional[datetime] = Field(None, alias='createdOn')
    updated_on: Optional[datetime] = Field(None, alias='updatedOn')
    data_object: DataObject = Field(..., alias='dataObject')
    value: Optional[str] = None
    truncated: Optional[bool] = None
...
class DataFormProviderExchange(KodexaBaseModel):
    ...
    data_objects: Optional[List[DataObject]] = Field(None, alias='dataObjects')
    data_attributes: Optional[List[DataAttribute]] = Field(None, alias='dataAttributes')
...
class Credential(ExtensionPackProvided):
...
DataAttribute.update_forward_refs()
