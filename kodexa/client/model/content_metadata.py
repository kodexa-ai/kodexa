...
def lazy_import():
    ...
    globals()['DocumentContentMetadata'] = DocumentContentMetadata
    globals()['ModelContentMetadata'] = ModelContentMetadata


class ContentMetadata(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'DocumentContentMetadata': DocumentContentMetadata,
            'ModelContentMetadata': ModelContentMetadata,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ContentMetadata - a model defined in OpenAPI
