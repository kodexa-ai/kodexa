    ...
    def __init__(self, api_client=None):
        ...
        def __create_access_token(
            ...
            **kwargs
            ...
            >>> thread = api.create_access_token(access_token, async_req=True)
            >>> result = thread.get()
        ...
        self.create_access_token = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/api/accessTokens',
        ...
        self.delete_access_token = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/accessTokens/{id}',
            ...
            api_client=api_client,
            callable=__delete_access_token
        )
        ...
        def __list_access_token(
            self,
            query_context,
            **kwargs
        ):
            """list_access_token  # noqa: E501

            List a page of the resources  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.list_access_token(query_context, async_req=True)
            >>> result = thread.get()
        ...
        self.list_access_token = _Endpoint(
            settings={
                'response_type': (PageAccessToken,),
                'auth': [],
                'endpoint_path': '/api/accessTokens',
                'operation_id': 'list_access_token',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_access_token
        )

        def __reindex_access_token(
            self,
            **kwargs
        ):
            """reindex_access_token  # noqa: E501

            Re-index the resource  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.reindex_access_token(async_req=True)
            >>> result = thread.get()
        ...
        self.reindex_access_token = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/accessTokens/_reindex',
                'operation_id': 'reindex_access_token',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__reindex_access_token
        )
        ...
        def __update_access_token(
            ...
            **kwargs
            ...
            >>> thread = api.update_access_token(id, access_token, async_req=True)
            >>> result = thread.get()
        ...
        self.update_access_token = _Endpoint(
            settings={
                'response_type': (AccessToken,),
                'auth': [],
                'endpoint_path': '/api/accessTokens/{id}',
            ...
            api_client=api_client,
            callable=__update_access_token
        )
