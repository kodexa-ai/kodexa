    ...
    def __init__(self, api_client=None):
        ...
        def __list_team(
            ...
            **kwargs
            ...
            >>> thread = api.list_team(query_context, async_req=True)
            >>> result = thread.get()
        ...
        self.list_team = _Endpoint(
            settings={
                'response_type': (PageTeam,),
                'auth': [],
                'endpoint_path': '/api/teams',
        ...
        def __reindex_team(
            ...
            **kwargs
            ...
            """reindex_team  # noqa: E501

            Re-index the resource  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.reindex_team(async_req=True)
            >>> result = thread.get()
        ...
        self.reindex_team = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/teams/_reindex',
                'operation_id': 'reindex_team',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        def __update_team(
            ...
            **kwargs
            ...
            >>> thread = api.update_team(id, team, async_req=True)
            >>> result = thread.get()
