...
public class KodexaSelectorLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"OR", "AND", "DIV", "MOD", "INTERSECT", "PIPELINE", "PATH_SEP", "ABBREV_PATH_SEP", 
			"ABBREV_STEP_SELF", "ABBREV_STEP_PARENT", "AXIS_SEP", "ABBREV_AXIS_AT", 
			"LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "UNION", "EQUALS", "REL_OP", 
			"PLUS", "MINUS", "MULT", "STAR", "COMMA", "COLON", "DOLLAR", "LITERAL", 
			"FLOAT", "INTEGER", "NODETYPE", "NCNAME", "FUNCNAME", "AXISNAME", "NameStartChar", 
			"NameChar", "DIGIT", "WS"
		};
	}
